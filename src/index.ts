...
import { TimeController } from './main/time-controller';
import { WindowManager } from './main/window-manager';
import { TrayManager } from './main/tray-manager';
import { SettingsManager } from './main/settings-manager';
...
function createApp(): void {
  ...
  // Paths for preload and renderer (provided by Webpack)
  ...
  trayManager = new TrayManager(trayIconPath, windowManager, settingsManager);
